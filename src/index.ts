...
const SCRIPTS: ReadonlyArray<{ actorName: string; line: string }> = [
  {
    actorName: "李 昊天",
    line: "こんばんは、フロントエンドカフェへようこそ。今夜も最新のフロントエンド界隈の技術をゆるっと語っていきます。まりもちゃん、今日もよろしく",
  },
  // {
  //   actorName: "苔村 まりも",
  //   line:
  ...
  // {
  //   actorName: "苔村 まりも",
  //   line: "なるほど…。でも、実際に開発するのはむずかしそうですね。わたしにもできるかな…。",
  // },
  // {
  //   actorName: "李 昊天",
  //   line:
  ...
  // {
  //   actorName: "苔村 まりも",
  //   line: "ありがとうございます、はやとさん。さっそくチャレンジしてみます。",
  // },
  // {
  //   actorName: "李 昊天",
  //   line:
