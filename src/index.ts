...
const SCRIPTS: ReadonlyArray<{ actorName: ActorName; script: string }> = [
  ...
  },
  {
    actorName: "苔村 まりも",
    script:
      "よろしくお願いします、ゆうとさん！最近、社内の勉強会でぴーだぶりゅーえーって言葉を聞いたんですけど、正直よくわからなくて…。今日はそのお話を聞いてもいいですか？",
  },
  {
    actorName: "陽斗・エイデン・グリーンウッド",
    script:
  ...
  {
    actorName: "苔村 まりも",
    script: "ありがとうございます、ゆうとさん！さっそくチャレンジしてみます！",
  },
  {
    actorName: "陽斗・エイデン・グリーンウッド",
    script:
...
async function main(): Promise<void> {
  ...
  await joinMp3FromUrls(urls, 0.7);

  await mixAudioWithBgm("bgm/bgm2.mp3", 0.2);
}
